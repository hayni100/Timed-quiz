...
function quizStart() {
 ...
 quizPage();
  ...
  //CREATE FUNCTION that subtracts time if wrong anwer is clicked//
...
var indexIncrementerBtn = document.querySelector("#index-incrementer");
//allows to change questions//
indexIncrementerBtn.addEventListener("click", function(e){
  e.preventDefault();
